                    ...
                    child: TextField(
                      ...
                      onChanged: (text) {
                        var existingInfo = chapterInputs.firstWhere(
                          ...
                          orElse: () =>
                              ChapterInfo(controller: controller, title: ''),
                        );
                            ...
                            onTap: () {
                              if (controller.text.trim().isEmpty) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                        'Please enter a value for $labelText.'),
                                  ),
                                );
                              } else {
                                if (chapterId == null) {
                                  insertChapter(
                                          widget.courseId, controller.text)
                                      .then((result) {
                                    setState(() {
                                      chapterId = result;
                                    });
                ...
                itemBuilder: (context, index) => Container(
                  ...
                  child: inputChapter(
                      ...
                      TextEditingController(
                          text: existingChapters[index]['title']),
                      context,
                      chapterId: existingChapters[index]['id'] as int),
                ),
              ),
              SizedBox(height: 20),
              ListView.builder(
                ...
                itemBuilder: (context, index) => Container(
                  ...
                  child: inputChapter(
                    'New Chapter',
                    chapterInputs[index].controller,
                    context,
                  ),
                ),
              ),
                ...
                onPressed: () {
                  setState(() {
                    ...
                    ChapterInfo newChapter =
                        ChapterInfo(controller: newController, title: '');
                      ...
                      Row(
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              if (chapterId == null) {
                                insertChapter(widget.courseId, controller.text)
                                    .then((result) {
                                  setState(() {
                                    chapterId = result;
                                  });
